...
import { FaSearch, FaUser, FaPhone, FaEnvelope, FaMapMarkerAlt, FaTimes } from 'react-icons/fa';
...
const Patient = () => {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'Arial, sans-serif' }}>
            ...
            {(!Array.isArray(filteredPatients) || filteredPatients.length === 0) && !loading && (
                <div style={{ 
                    textAlign: 'center', 
                    padding: '40px',
                    color: '#718096'
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'grid', gap: '15px' }}>
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
                                ...
                                {(selectedPatient.emergencyContact || selectedPatient.insurance) && (
                                    <div style={{ flex: '1', minWidth: '200px' }}>
